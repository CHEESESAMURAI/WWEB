...
const Tracking: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTrackedProducts = async () => {
      ...
      try {
        ...
        setError(err.message || 'Ошибка при загрузке отслеживаемых товаров');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const handleDeleteTrackedProduct = async (productId: number) => {
    try {
      ...
      alert(err.message || 'Ошибка при удалении товара из отслеживаемых');
    }
  };
    ...
    <Box>
      ...
      {isLoading ? (
        ...
        <TableContainer component={Paper}>
          <Table aria-label="tracked products table">
            <TableHead>
              <TableRow>
