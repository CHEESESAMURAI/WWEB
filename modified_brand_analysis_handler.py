"""
Модифицированный обработчик анализа бренда

Этот файл содержит модифицированную версию функции handle_brand_name
для замены в файле new_bot.py. Функция теперь может принимать
как названия брендов, так и артикулы товаров.

Для применения изменений:
1. Найдите текущую функцию handle_brand_name в new_bot.py (примерно строки 448-500)
2. Замените её на версию из этого файла
"""
